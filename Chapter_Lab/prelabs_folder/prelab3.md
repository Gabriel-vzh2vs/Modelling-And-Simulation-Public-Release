(prelab-2)=
# Pre-Lab 2: Validity and Verification in Simulation Models (Read)
...
Implementation relies on a reasonable amount of complexity and a infrastructure that can be understood and verified by the practitioners as a useful tool and not reality itself. It is often stated in Simulation textbooks such as {cite}`Law:13`, that face validity is a critical part of making models that are suitable for obtaining founded
