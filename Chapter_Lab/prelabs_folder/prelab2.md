...
Copulas are dicussed in more detail in a future chapter.
...
a random variate through a random variate generator (which is defined by a
distribution such as a uniform or a Gaussian distribution) and through
an output function it becomes simulated values. These values are then
...
Often times, in XLrisk, a user will pick a number of iterations, and through the Weak Law of Large Numbers[^2], 
